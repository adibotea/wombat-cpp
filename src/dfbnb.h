 ...
 *  wombat
 *
 *  Created by Adi Botea on 09/05/2022.
...
class DFBnB : public Search
{
public:
    ~DFBnB();
    DFBnB(Node & root, double maxTime, int maxNodes, int maxSolutions,
    ...
    DFBnB(Node & root, string summaryFileName);
    int runSearch();
